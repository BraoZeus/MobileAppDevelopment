                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Created: ${DateFormat('MMM dd, yyyy h:mm a').format(subject.createdAt)}',
                              style: TextStyle(fontSize: 11, color: isDark ? Colors.white54 : Colors.grey.shade600),
                            ),
                            if (subject.startDate != null)
                              Text(
                                'Started: ${DateFormat('MMM dd, yyyy h:mm a').format(subject.startDate!)}',
                                style: TextStyle(fontSize: 11, color: isDark ? Colors.white54 : Colors.grey.shade600),
                              ),
                            if (subject.completedAt != null)
                              Text(
                                'Completed: ${DateFormat('MMM dd, yyyy h:mm a').format(subject.completedAt!)}',
                                style: TextStyle(fontSize: 11, color: isDark ? Colors.white54 : Colors.grey.shade600),
                              ),
                          ],
                        ),
