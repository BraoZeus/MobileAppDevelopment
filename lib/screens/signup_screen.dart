...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _handleGoogleSignIn() async {
    ...
    try {
      ...
      // Google accounts are pre-verified by Google, so they bypass email links
      if (user != null && mounted) {
        // Direct navigation layout implementation goes here
      }
    } catch (e) {
      setState(() {
        _errorMessage = e.toString().replaceAll('Exception: ', '');
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Text("Log in", style: TextStyle(color: Color(0xFF334195), fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
